...
const card = (
  <Card sx={{ maxWidth: 345, backgroundColor: 'whitesmoke', border: "0.5px beige solid",
          padding: "4px", }}>
    <CardContent >
         <Avatar
            alt="HHaluk_github"
            ...
            />
      <Typography  sx={{ fontSize: 16, mt: 1, fontWeight: 500  }} style={{fontWeight: '600'}} color="text.secondary" gutterBottom>
      ...
      <Typography color="text.secondary">
        ...
        Lately super active on Medium & GitHub.<br/>
        Feel free to contact me 😎 <br/> <br/>
        #opensource #cloudnative #mtb 
      </Typography>
    </CardContent>
     <CardContent >
